...
class UserFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_file" do
    assert_difference('UserFile.count') do
      post user_files_url, params: { user_file: { float: @user_file.float, string: @user_file.string, timestamp: @user_file.timestamp } }
    end
  ...
  test "should update user_file" do
    patch user_file_url(@user_file), params: { user_file: { float: @user_file.float, string: @user_file.string, timestamp: @user_file.timestamp } }
